...
param serviceBusOrderConnName string = 'servicebusorderconnname'
...
resource serviceBusConnectionString 'Microsoft.KeyVault/vaults/secrets@2021-11-01-preview' = {
  parent: keyVaultRef
  name: serviceBusOrderConnName
  properties: {
    value: listKeys(serviceBusEndpoint, serviceBusNamespace.apiVersion).primaryConnectionString
  }
}

output serviceBusConnStrRef string = '@Microsoft.KeyVault(SecretUri=${reference(serviceBusOrderConnName).secretUriWithVersion})'
